      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <AboutTile className="md:col-span-2">
            <div className="absolute top-8 right-8 w-10 h-10 rounded-lg flex items-center justify-center text-purple-bright border border-white/15" style={{ background: "linear-gradient(135deg, rgba(46,107,255,0.15), rgba(168,85,247,0.15))" }}>
